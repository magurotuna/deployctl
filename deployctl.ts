...
import downloadSrcSubcommand from "./src/subcommands/download_src.ts";
...
SUBCOMMANDS:
    ...
    download-src Download the source code of a deployment
...
switch (subcommand) {
  ...
  case "projects":
    ...
    break;
  case "download-src":
    await downloadSrcSubcommand(args);
    break;
  default:
    if (args.version) {
